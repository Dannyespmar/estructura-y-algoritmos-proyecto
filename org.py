...
def ordenar_productos():
    ...
    if metodo_seleccionado.get() == "Insertion Sort":
        insertion_sort(productos)
    elif metodo_seleccionado.get() == "Merge Sort":
...
raiz = tk.Tk()
raiz.title("Ordenamiento de Productos por Cantidad")
...
metodo_seleccionado.set("Insertion Sort")

opcion_metodo = tk.OptionMenu(raiz, metodo_seleccionado, "Insertion Sort", "Merge Sort")
opcion_metodo.pack()
